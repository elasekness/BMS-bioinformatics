...
## Perform a GO term enrichment or a pathway analysis with KEGG
...
"KEGG is a database resource for understanding high-level functions and utilities of the biological system, such as the cell, the organism and the ecosystem, from molecular-level information, especially large-scale molecular datasets generated by genome sequencing and other high-throughput experimental technologies." -- https://www.kegg.jp/

With either approach, we are looking to group genes by some form of similarity (functionality or part of the same pathway) and determine which terms, if any, are significantly enriched for being up or down-regulated.

Here we'll explore our results more with [KEGG](https://www.kegg.jp/) and [iPath3](https://pathways.embl.de/tools.cgi).

Classify your DEGs with KAAS from KEGG. Then submit to iPath to explore the results. 

You can also try [DAVID](https://david.ncifcrf.gov/gene2gene.jsp) to look for functional enrichment.
